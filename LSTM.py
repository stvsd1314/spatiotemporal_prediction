...
# -*- coding: utf-8 -*-
"""
Created on Sun Jun 28 09:54:45 2020
...
# design network
model = Sequential()
model.add(GRU(200, input_shape=(n_min, n_features)))
...
# acc = model.evaluate(x=test_X[:94,:], y=test_y[:94,:], batch_size=None, verbose=0, sample_weight=None)

print(np.mean(np.array(history.history['val_acc'])))
